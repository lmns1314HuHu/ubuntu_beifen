...
hi Constant		  term=underline                              ctermfg=220                                                 guifg=#ffa0a0
hi Special		  term=bold                                   ctermfg=223                                                 guifg=orange
hi Identifier	  term=underline                              ctermfg=brown                                               guifg=#40ffff
hi Statement	  term=bold            cterm=bold             ctermfg=213                              gui=bold           guifg=#ffff60
hi PreProc		  term=underline                              ctermfg=38                                                  guifg=#ff80ff
hi Type			  term=underline       cterm=bold,italic             ctermfg=lightgreen                       gui=bold           guifg=#60ff60
